  ...
  return (
    ...
    >
      <div className="absolute inset-0 [transform:rotateX(var(--grid-angle))] overflow-hidden">
        <div className="animate-grid [background-image:linear-gradient(to_right,var(--light-line)_1px,transparent_0),linear-gradient(to_bottom,var(--light-line)_1px,transparent_0)] [background-repeat:repeat] [background-size:var(--cell-size)_var(--cell-size)] h-full w-full [transform-origin:50%_50%_0] dark:[background-image:linear-gradient(to_right,var(--dark-line)_1px,transparent_0),linear-gradient(to_bottom,var(--dark-line)_1px,transparent_0)]" />
      </div>
    ...
    return (
      <div className={cn("relative overflow-hidden", className)} ref={ref} {...props}>
        ...
        <section className="relative max-w-full mx-auto z-1 overflow-hidden">
          ...
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-24 md:py-32 lg:py-36 gap-12 md:px-8 flex items-center min-h-[85vh]">
            <div className="space-y-8 md:space-y-9 max-w-4xl leading-0 lg:leading-5 mx-auto text-center">
              ...
              <h2 className="text-5xl md:text-7xl lg:text-8xl tracking-tighter font-geist bg-clip-text text-transparent mx-auto bg-[linear-gradient(180deg,_#000_0%,_rgba(0,_0,_0,_0.75)_100%)] dark:bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)]">
                {subtitle.regular}
                {typeof subtitle.gradient === 'string' ? (
              ...
              <div className="items-center justify-center gap-x-3 space-y-6 sm:flex sm:space-y-0 pt-4">
                <span className="relative inline-block overflow-hidden rounded-full p-[1.5px]">
                  <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
                  <div className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-white dark:bg-gray-950 text-xs font-medium backdrop-blur-3xl">
                    <a
                      href={ctaHref}
                      className="inline-flex rounded-full text-center group items-center w-full justify-center bg-gradient-to-tr from-zinc-300/20 via-purple-400/30 to-transparent dark:from-zinc-300/5 dark:via-purple-400/20 text-gray-900 dark:text-white border-input border-[1px] hover:bg-gradient-to-tr hover:from-zinc-300/30 hover:via-purple-400/40 hover:to-transparent dark:hover:from-zinc-300/10 dark:hover:via-purple-400/30 transition-all sm:w-auto py-6 px-12 text-lg md:text-xl font-medium"
                    >
                      {ctaText}
                    </a>
                  </div>
            ...
            {bottomImage && bottomImage.light && bottomImage.dark && (
